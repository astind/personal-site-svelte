...
<div class="flex justify-between">
  <Header {title}></Header>
  <a class="btn btn-neutral" href="https://drive.google.com/file/d/1HfID1xBbxIOh7U5xiw0I257iF8aJ1sTm/view?usp=drive_link">Download</a>
</div>
...
<div class="mt-8">
  ...
  <div class="px-4">
    <ol class="relative border-s border-primary">                  
      <li class="ms-4">
        <div class="absolute w-3 h-3 bg-primary rounded-full mt-1.5 -start-1.5 border border-base-100 bg-primary"></div>
